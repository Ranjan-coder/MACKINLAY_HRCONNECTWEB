...
Chart.register(ArcElement);
    ...
    return (
        <>{AppliedUsers && AllJobs?<div className="main_candidate">
            ...
            {candidatetype === "Rejected" && <GenericCandidate type={candidatetype} Users={ShortedCandidates.Rejected} job={AllJobs} ShowApplicantDetails={ShowApplicantDetails} CbToggleDetails={setShowApplicantDetails} />}
            {candidatetype === "Shortlisted" && <GenericCandidate type={candidatetype} Users={ShortedCandidates.Selected} job={AllJobs} ShowApplicantDetails={ShowApplicantDetails} CbToggleDetails={setShowApplicantDetails} />}
            {candidatetype === "Bookmarked" && <GenericCandidate type={candidatetype} Users={ShortedCandidates.Bookmarked} job={AllJobs} ShowApplicantDetails={ShowApplicantDetails} CbToggleDetails={setShowApplicantDetails} />}
            {ViewProfile && !ShowApplicantDetails && <GenericApplicantView Users={AppliedUsers} selectedUser={SelectedUser} ShowApplicantDetails={ShowApplicantDetails} CbToogleDetails={setViewProfile} />}
                                ...
                                <tbody>
                                    {AppliedUsers.map((item, index) => (
                                        <tr key={index}>
                                            ...
                                            <td><button className='bulkAction_btn' onClick={(e) => handleViewProfile(item?._id)} >View Profile</button></td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
